    ...
    async function getData() {
      try {
        const response = await fetch(
          `https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${long}&format=json&apiKey=a5180e0fbaf94b01bdf90a0fd4cf306e`
        );
...
function search() {
  ...
  const url = `https://api.geoapify.com/v1/geocode/search?text=${addressInput.value}&apiKey=a5180e0fbaf94b01bdf90a0fd4cf306e`;

  async function searchData() {
    try {
      const response = await fetch(
        `https://api.geoapify.com/v1/geocode/search?text=${addressInput.value}&apiKey=a5180e0fbaf94b01bdf90a0fd4cf306e`
      );
